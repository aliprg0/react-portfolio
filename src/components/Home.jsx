...
const Home = () => {
    return (
        <div name="home" className='flex h-screen w-full  bg-gradient-to-b from-black to-gray-800'>
            <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 text-white bsmmd:flex-row'>
                <div className='flex flex-col justify-center h-full mt-20 md:mt-60  bsmmd:mt-0 bsmmd:space-y-12'>
                    ...
                    <div>
                        <button className='text-white w-fit px-6 ppy-3 my-2 flex items-center rounded-md  bg-gradient-to-r h-8 bsmmd:h-12 bsmmd:text-xl from-cyan-500 to-blue-500 cursor-pointer'>
                            Portfolio
                            <span>
                ...
                <div className='w-[25rem] bsmmd:w-[40rem] lg:w-[48rem]'>
                    <img src={HeroImage} alt="my profile" className='rounded-full overflow-hidden' height='' />
                </div>
            </div>
        </div>
    )
